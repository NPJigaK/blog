---
pubDatetime: 2019-04-09T08:51:13.737Z
title: 【PUBG】タイムゾーンを1クリックで変更する方法【東京⇔北京】
featured: false
tags:
  - PUBG
  - ゲームライフハック
category: ゲーム関連
description: 1クリックで簡単にPUBGの鯖を変更する方法を紹介します。
---
...
ここ最近は4×4マップが人気ですが、たまには8×8マップもやりたくなりますよね。  
でも8×8マップはあまり人気がなくて、マッチングに時間がかかりがち…。  
スクリムとかに出ていないと、プレイする機会が少ないのが悩みどころです。  

そんなときは、**PCのタイムゾーンを北京にする**だけで、マッチングにかかる時間を大幅に短縮できるってご存じでしょうか？

今回は、**1クリックで簡単にPUBGの鯖を変更する方法**を紹介します！
...
しかし、Windowsの「日付と時刻の設定」から手動で変更するのは、**3~4回くらいのクリック操作が必要**で、毎回この操作をするのは面倒です…。  
...
![tokyo-beijing.bat](@/assets/images/blog/2019/tokyo-beijing.jpg)
